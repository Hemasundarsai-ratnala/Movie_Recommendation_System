...
class Settings(BaseModel):
    ...
    CORS_ORIGINS: list[str] = [
        ...
        for origin in _get_env_str(
            "CORS_ORIGINS",
            "http://localhost:5173,http://localhost:5174,http://localhost:5175,http://localhost:3000,http://127.0.0.1:5173,http://127.0.0.1:5174,http://127.0.0.1:5175,https://movie-recommendation-system-i8o4.onrender.com",
        ).split(",")
        if origin.strip()
    ]
